...
nnoremap <silent> <Plug>(lsp-selection-expand) <Cmd>call lsp#SelectionExpand()<CR>
xnoremap <silent> <Plug>(lsp-selection-expand) <Cmd>call lsp#SelectionExpand()<CR>
xnoremap <silent> <Plug>(lsp-selection-shrink) <Cmd>call lsp#SelectionShrink()<CR>
